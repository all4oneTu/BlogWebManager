...
function PostPage() {
  ...
  return (
    <div className="mx-auto my-7 max-w-5xl">
      ...
      <div className='-my-5 rouded-b-md border border-t-0 border-gray-300 bg-white py-5 px-10'>
        <hr className="py-2" />
        {
          post?.comment.map(comment => (
            <div className="relative flex items-center space-x-2 space" key={comment.id}>
              <div>
