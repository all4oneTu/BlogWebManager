...
function PostBox() {
  ...
  return (
    <form onSubmit={on} className="sticky top-16 z-50 rounded-md border-gray-500 bg-white p-2">
      ...
      {!!watch('postTitle') && (
        <div className="flex flex-col py-2">
          ...
          {!!watch('postTitle') && (
            <button type="submit" className="w-full rounded-full bg-blue-200 p-2 text-white">
              Create Post
            </button>
          )}
        </div>
